...
class MistralDenseEmbedder(DenseEmbedder):
    ...
    Chunks are grouped into batches because the Mistral Embeddings API accepts a
    list of inputs per call. Batches are sent concurrently, bounded by a semaphore
